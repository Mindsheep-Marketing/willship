...
import RenderGrid from "../../../components/commercial/RenderGrid";
import CommercialHeader from "../../../components/layout/CommercialHeader";
import siteMap from "../../../siteMap";

const SuccessStoriesPage = ({post} : {post: BlogItem}) => {
      ...
      <main>
        <div className="w-full flex flex-col items-center bg-nearlyWhite py-12 px-4">
          <div className="flex flex-row gap-2 sm:gap-4 text-darkBlue font-medium text-sm sm:text-xl items-center">
            ...
            <p>&gt;&gt;</p>
            <Link href='/freight-forwarder/success-stories'>
              <a>Success Stories</a>
            </Link>
          </div>
                  ...
                  return (
                    <div key={i}>
                      {item.type === 'text' ? (
                        ...
                        <RenderGrid items={item.content as string[]} />
                      ) : (
