...
export default function ThankYouMachineryImport() {
  const router = useRouter();

  useEffect(() => {
    // Redirect to the machinery import hub after 3 seconds
    const timer = setTimeout(() => {
      window.location.href = 'https://importhub.willship.com.au/machinery-import-hub';
    }, 3000);
  ...
  return (
    <>
      <Hero
        ...
        subHeading={
          <>
            <p>Thank you for your inquiry. You will be redirected to our Machinery Import Hub.</p>
